...
export function createBear(type = 'splashy', cosmeticId = null) {
    ...
    const leftArmMesh = createVoxel(0, -armHeight/2, 0, armWidth, armHeight, armDepth, bodyMat);
    ...
    const rightArmMesh = createVoxel(0, -armHeight/2, 0, armWidth, armHeight, armDepth, bodyMat);
